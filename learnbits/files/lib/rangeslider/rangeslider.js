...
(function(factory) {
    ...
    function Plugin(element, options) {
        ...
        // DK: added an ID to the handle object so ut's easy to retrieve for updating the value
        this.$handle    = $('<div class="' + this.options.handleClass + '" id="' + this.$element.attr('id') + '-val" />');
