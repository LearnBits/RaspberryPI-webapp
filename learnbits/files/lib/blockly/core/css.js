...
Blockly.Css.CONTENT = [
  '.blocklySvg {',
    'background-color: #FFFAF0;', // DK: customize, main workspace
    'outline: none;',
  ...
  '.blocklyText {',
    'cursor: default;',
    'fill: #fff;',
    'font-family: "Nunito", sans-serif;', /* DK: customize. added Nunito */
    'font-size: 11pt;',
  '}',
  ...
  */
  ...
  '.blocklyToolboxDiv {',
    'background-color: #eee;', // DK: customize
    'overflow-x: visible;',
    'overflow-y: auto;',
    'position: absolute;',
  '}',
